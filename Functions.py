...
# from Configuration import project_folder, input_folder, file_identifier, region_id, country
...
def define_region_id(exp):
    ...
    mekong = gpd.read_file('/Users/qinhan/Documents/AXA/ECA_Vietnam/Exposure/Viet_provinces/Mekong_region.shp')
    north = gpd.read_file('/Users/qinhan/Documents/AXA/ECA_Vietnam/Exposure/Viet_provinces/north_region.shp')
...
def tracks_ID(storm_range=hist_storms):
    ...
    ibtracs = pd.read_csv('/Users/qinhan/Downloads/ibtracs.WP.list.v04r00.csv', skiprows=[1], delimiter=',',
...
# def translate_rp_category(IMP, HAZ, target_return_period):
#
...
#
#     category = HAZ.category[sort_idxs][::-1]
#
#     interp_category = np.interp(target_return_period, return_per, category)
#
#     return interp_category